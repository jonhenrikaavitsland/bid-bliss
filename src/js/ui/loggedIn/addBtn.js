...
export function addBtn() {
  ...
  const btn = createBtn('new auction', 'py-3', 'px-4', 'md:py-3', 'md:px-6', 'text-white', 'bg-primary', 'hover:bg-hoverPrimary', 'rounded-xl', 'uppercase', 'font-serif', 'font-medium', 'lg:hidden');
